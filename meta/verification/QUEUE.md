...
Landed, awaiting a verifier: none outside the running WPs.
...
Running: WP-0.2y, WP-5.6 native render (+ cover step). WP-3.9 landed 0508801 and WP-0.0f 38550f4: `--adhoc 008`
...
Next: WP-4.1, WP-4.2, WP-4.3, WP-6.1.
