# ComfyUI execution cache (source: comfy_execution/caching.py)

> Archived for `meta/plans/graph-execution-model.md`.
> Source: <https://raw.githubusercontent.com/comfyanonymous/ComfyUI/master/comfy_execution/caching.py>
