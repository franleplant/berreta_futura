...
When a server’s tools change, the client can refresh its registry and notify an active conversation of the new capabilities. The protocol keeps that exchange current; the application still decides what the model does with it.
