...
Even before AI, only 25–50% of the time to ship a feature was writing the code itself. The rest was aligning/planning, reviewing/reworking code, and testing/verifying the solution.

## Seeking leverage

Using AI only to write the code takes the 2–4 hours of coding time down to 10–20 minutes, but you haven't accelerated anything else here.

Using AI to help you plan and align gets you closer to 2–3x faster.

## The 80/20 rule in AI coding leverage

Let's assume you yolo a two-sentence prompt into your factory: your chance of getting a fully-mergeable result is ~50%, and the chance you have to rework it is 50%.
...
For this example I'm gonna blur “chance you'll have to change something” weighted by “how painful the change will be” into a single percentage number, but obviously they're two separate variables. The model is 50% likely to get a button style wrong, but the fix is one cheap prompt, so our combined “expected pain” is low.

> expected pain = P(you'll have to change it) × how painful the change is

Drawing this out shows an inverse relationship between effort invested up front and expected pain.
