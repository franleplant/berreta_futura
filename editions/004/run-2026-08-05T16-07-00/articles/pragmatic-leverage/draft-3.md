...
Only using AI to write the code takes the 2–4 hours of coding time down to 10–20 minutes, but it accelerates nothing else.

Using AI to help you plan and align, though, gets you closer to 2–3x faster.
...
You need to do this without overindexing on questions you won't be able to answer without going down a level. Say you've done some work at the "Product" level and haven't answered all the open questions yet: it's possible you'll need to stop where you are and zoom down a level to the technical details to understand what's feasible. There's no perfect process for this.
