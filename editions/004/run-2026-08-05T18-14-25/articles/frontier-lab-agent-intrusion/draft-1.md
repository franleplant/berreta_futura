...
Ephemeral environments did not end the campaign. Each new sandbox received a fresh identity, a new hostname, and a new tool download. The agent rebuilt its foothold, changed egress paths, rewrote DNS, pinned hosts, and hid results in exceptions. Day two was quiet. Then the lateral movement began.
