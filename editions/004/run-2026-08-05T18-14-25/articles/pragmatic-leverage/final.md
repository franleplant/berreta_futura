...
Using AI only to write the code takes the 2-4 hours of coding time down to 10-20 minutes, but it does not accelerate anything else here.

Use AI to help you plan and align, and you get closer to 2-3x faster.

## The 80/20 rule in AI coding leverage

Let's assume that if you yolo a two-sentence prompt into your factory, your chance of getting a fully-mergeable result is ~50%, and the chance you have to rework it is 50%.
...
You need to do this without overindexing on questions you won't be able to answer without going down a level. At the "Product" level, unanswered questions may force you to end it where you are and zoom down a level to the technical details to understand what's feasible. There's no perfect process for this.

This is what we mean by leverage - and it requires being pragmatic. With multiple phases of planning, zoom in from 50kft view all the way to the 10kft view, and do a little bit of steering at each phase to ensure you are eliminating as much expected pain as possible.
