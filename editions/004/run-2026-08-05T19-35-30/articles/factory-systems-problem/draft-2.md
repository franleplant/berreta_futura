...
Here is the service-bus hot take: n8n was a silly idea, which I’ve always suspected was developed by young folks in Silicon Valley who are all in on the LLM craze who have never worked in corporate in their lives, thus didn’t have the knowledge that service buses are a solved problem and there’s deep prior art in the spooky land of enterprise. Anything in the .NET space, such as MassTransit, NServiceBus, and WCF, is worth looking up if you wanna steal ideas for prompting. If you want a modern plug-and-play choice, @temporalio exists. Use it and have a job invoke an agent as a process. Making the entire service bus non-deterministic would be a mistake. Lots of bad memories here. Not great tech impl, but the theory / education is generally on point.
