...
### Slide 1: What will be left for us to work on? Arvind Narayanan Professor of Computer Science Co-author of AI as Normal Technology
...
### Slide 2: Where I’m coming from

I lead a team at Princeton University trying to advance the [science of AI agent evaluation](https://sage.cs.princeton.edu/). We try to go beyond the usual claims of “Look, capability is going up on benchmarks!” Those claims tend to be misinterpreted by the broader public as implying that agents are soon about to take all our jobs.
...
The work that I'm better known for is the essay I co-authored with Sayash Kapoor called [AI as Normal Technology](https://knightcolumbia.org/content/ai-as-normal-technology). It's a way to think about the medium-term future of AI and how to adapt to it — and in turn how to adapt it to the needs of society and the economy.
...
Our response to this moment matters beyond this community. The whole world is watching. If we simply roll over and accept that a lot of our work will be done by AI in the future, instead of setting clear boundaries, I think it will lead to an even stronger political backlash against AI than what we are seeing today. So I think this question is not just for us but it's for the whole world.

### Slide 4: A battle of two narratives
...
### Slide 5: What is “AI as Normal Technology”?
...
### Slide 8: Applying diffusion-of-innovations theory to AI
...
### Slide 9: Applying diffusion-of-innovations theory to AI
...
### Slide 10: What does transformation look like? Historical analogy: electrification of factories
...
### Slide 11: Data from Anthropic (March 2026)
...
### Slide 12: The #1 concern about AI
...
### Slide 13: Our reliability metric is a composite of:
...
### Slide 14: AI agents: the capability-reliability gap
...
### Slide 16: Prediction: collaboration agents will continue to be more successful than automation agents.
...
### Slide 17: Why labor impacts are gradual — And not necessarily negative
...
### Slide 18: Fact check: Is AI replacing software engineers?
...
### Slide 19: Writing code was never the bottleneck
...
### Slide 21: The decide-execute-deliver sandwich
...
### Slide 22: A useful metaphor: A crane operator
...
### Slide 23: Change is constant in software engineering
...
### Slide 24: The “lump of labor” fallacy
...
### Slide 25: Other notable examples
...
### Slide 28: If RSI is achieved, what are the consequences?
...
### Slide 29: AGI discourse suffers from the Hawaii problem
...
### Slide 34: Some hypotheses about AI creativity
...
François Chollet in particular has talked about the fact that human representations that underpin our creativity seem to exhibit a kind of extreme compositionality, where everything is built up from a few "[atoms of meaning](https://singjupost.com/francois-chollet-how-we-get-to-agi-transcript/)". Many seeming limitations of human working memory and information processing actually turn out to be strengths, because they force us to come up with these extremely efficient representations.
...
### Slide 35: Can we empirically test AI ability to do humanlike AI research?
...
### Slide 36: We call this “open-world evaluation”

This builds on a foundation that we call [open-world evaluation](https://arxiv.org/abs/2605.20520). We've completed one open-world evaluation of getting agents to [build and upload an app](https://cruxevals.com/crux-1) to the Apple App Store — that's not about recursive self-improvement, but it tests a different kind of thing. We have assembled a great team, with people from many universities, a couple of companies, as well as the UK AI Security Institute.

And by the way, we are [hiring](https://cruxevals.com/careers/senior-researcher-july-2026) a researcher to lead some of our future open-world evaluations. If you're interested, go check out our website.

### Slide 37: Four dimensions of advanced AI

Now let's turn to the third of the four dimensions.

### Slide 38: Economically transformative AI
...
### Slide 39: What are the remaining barriers?
...
### Slide 40: Four dimensions of advanced AI

Okay. Now let me talk about the last of these dimensions, namely superintelligence.

### Slide 41: Three claims about superintelligence
...
### Slide 42: Putting it all together: Four dimensions of advanced AI
...
### Slide 44: General observation: Purely technical skills get devalued
...
### Slide 45: Effort shifts from building to evaluation
...
### Slide 46: AI agent evaluation has become a distinct discipline
...
### Slide 47: Evaluation is how we “steer the ship”
...
### Slide 48: How much of conferences such as ICML should be about evaluation?
...
### Slide 49: How we evaluate research itself must change
...
### Slide 50: Automating peer review is a trap
...
### Slide 51: How will AI change science?
...
### Slide 52: What about companies? Evals as the new IP
...
*(Note: in [this post](https://substack.com/@aisnakeoil/note/c-287365888) I explain the idea of cross-functional eval teams to keep companies from fooling themselves.)*

### Slide 53: How effort shifts from building to evaluation
...
### Slide 54: Personal reflections on adapting to AI
...
Here are two heuristics that I've tried to use in order to do that. The first is resisting the black-box temptation. Companies want us to use agents as black boxes — just prompt it and it will go off and do its thing. I think that's a [trap](https://substack.com/@aisnakeoil/note/c-259452894). I think that's very dangerous, and it will lead us to gradually give up control over time.

Second, and related, is what I call the [dependence spiral](https://substack.com/@aisnakeoil/note/c-274974582). It's very tempting to use AI for tasks that I am myself not yet an expert at, because learning new things is of course very hard. But that leads to my losing whatever little skills I have in that task. It's much better in the long run if I first put in the time to master the task myself before I use AI to augment my productivity.

### Slide 55: The vision: co-superintelligence
