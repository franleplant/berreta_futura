...
tools/imagegen "Panel 1: Pedro and Maro lean in close over a drooping, wilted seedling in the clay pot on the windowsill, alarmed. Pedro's speech balloon says exactly: \"It's dying!\" $STYLE

$CAST" --out "$OUT/panel-1.png" --ref "$REF" &

tools/imagegen "Panel 2: Maro proudly holds up a wrench pulled from his coral tool pouch, antenna perked, while Pedro looks doubtful with a hand behind his head. Maro's speech balloon says exactly: \"I can fix it!\" $STYLE

$CAST" --out "$OUT/panel-2.png" --ref "$REF" &

tools/imagegen "Panel 3: Flopaz steps in between them holding a small watering can, gently lowering Maro's wrench arm with her other hand, calm and knowing, and waters the seedling. Flopaz's speech balloon says exactly: \"Watch this.\" $STYLE

$CAST" --out "$OUT/panel-3.png" --ref "$REF" &

tools/imagegen "Panel 4: the seedling stands tall with one small coral flower; Pedro cheers with both fists up, Maro's eyes curve extra happy holding the wrench limp at his side, Flopaz smiles with the empty watering can. Maro's speech balloon says exactly: \"You fixed it!\" Flopaz's smaller balloon says exactly: \"Just water.\" $STYLE
