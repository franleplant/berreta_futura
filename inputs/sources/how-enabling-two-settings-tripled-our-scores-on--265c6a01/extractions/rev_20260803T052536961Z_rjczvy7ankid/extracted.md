---
schema_version: 1
source_id: how-enabling-two-settings-tripled-our-scores-on--265c6a01
raw_bundle: d3fcbd6c8c93e92da3c3e493c8ba111ef2ec1fec4ca3899f29432ca40e2df0f1
artifacts:
- article.md
extraction_method: >-
  Verbatim extraction of the title and substantive article body from
  artifacts/article.md. Capture metadata is omitted. Retained wording,
  headings, list structure, and paragraph order match the archived rendered text.
---
...
Models are not told how they will be scored, and cannot see their score throughout—actions only return a text representation of each frame and what level they are on.
...
In gaming, GPT‑5.6 Sol has beaten Pokémon FireRed with a vision-only harness (as streamed by GPT_Plays_Pokemon), Slay the Spire with Codex computer use (as streamed by EpochAI), and the first stages of Baba Is You (as shared by Piotr Migdał & Piotr Grabowski). What was so different about ARC-AGI-3?

Ethan Mollick shows GPT‑5.6 Sol in Codex beating a randomized daily challenge in Slay the Spire 2, a game released after GPT‑5.6 Sol’s knowledge cutoff.

Inspired by ARC’s analysis of GPT‑5.5’s shortcomings, we examined some of the GPT‑5.6 Sol’s attempts. Like ARC, we saw that the model didn’t appear too bright. It dwelled a long time on each action and struggled to make progress.
