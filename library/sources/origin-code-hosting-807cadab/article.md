...
![Vercel, Depot, and Buildkite apps connected to an Origin repo](media/001.png)

## Settings

Every repo has settings. Check sync status for GitHub repos, manage who has access, and see which apps are connected.

![Origin repo settings showing sync status, access, and connected apps](media/002.png)
