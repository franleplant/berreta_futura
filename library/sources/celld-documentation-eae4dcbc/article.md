...
the bucket. The [ownership and fencing](https://celld.dev/docs/fencing) page gives the full
...
DigitalOcean Spaces do not. See [ownership and fencing](https://celld.dev/docs/fencing)
...
the [limitations](https://celld.dev/docs/limitations) for the current deployment boundary.
...
public internet. See the [security](https://celld.dev/docs/security) page for the complete boundary.
