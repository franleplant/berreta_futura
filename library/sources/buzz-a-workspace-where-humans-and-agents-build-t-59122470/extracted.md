---
schema_version: 1
source_id: buzz-a-workspace-where-humans-and-agents-build-t-59122470
raw_bundle: 1897cc7ea085e81c39fbccc5439f0d01dadcb505cc3b6867db8eb579d5df9a54
artifacts:
- README.md
- VISION.md
- ARCHITECTURE.md
extraction_method: >-
  Verbatim concatenation of the captured repository documents README.md, VISION.md, and ARCHITECTURE.md, in that order, each introduced by an HTML-comment file boundary marker. Document text is unmodified.
---
