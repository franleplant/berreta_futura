---
schema_version: 1
source_id: prime-agent-a-self-improving-rlm-agent-2c19ce14
raw_bundle: 534a5c4452dcf295d2c21fc2329cc0a043ed354e22a89fd03ca3fad968a3e215
artifacts:
- article.md
extraction_method: >-
...
By Seth Karten, Alex L. Zhang, Kevin Thomas, Sebastian Müller, and the Prime Intellect Team · Prime Intellect Blog · August 5, 2026
...
![Prime Agent onboarding splash screen](media/002.gif)
...
![Prime Agent architecture diagram](media/003.png)

*Caption:* RLM and Continual Harness are the two core abstractions; sub-agent CRUD plus Agent2Agent messaging compose them into orchestration.
...
![Prime Agent text user interface](media/004.png)
...
![Prime Agent Agents View listing running, idle, and inactive sessions](media/005.png)
...
![ARC-AGI-3 test-time compute scaling: score vs. output tokens per game](media/006.svg)

![ARC-AGI-3 cost scaling: score vs. estimated API cost](media/007.svg)

*Caption:* ARC-AGI-3: (left) test-time compute scaling: score vs. output tokens per game. (right) cost scaling: score vs. estimated API cost.
...
![EmulatorBench: score vs. cost on creating a Sega Genesis emulator](media/008.svg)

![EmulatorBench: score vs. cost on creating a Game Boy Color emulator](media/009.svg)

*Caption:* EmulatorBench: Score vs. Cost on creating (left) Sega Genesis emulator and (right) Game Boy Color emulator.
...
![PMPP-Hard benchmark results for Prime Agent](media/010.svg)
...
![Prime Agent playing Factorio with four controllable characters](media/011.png)

*Caption:* Prime Agent using subagents and programmatic tool calling to cheat on Factorio by teleporting resources directly into machines.
...
![MazeBench results: rooms, states, and gems as a function of token spend](media/012.svg)
