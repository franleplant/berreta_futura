---
schema_version: 1
source_id: why-software-factories-fail-turning-the-lights-b-1312d1ad
raw_bundle: 570a376a03e24be8a47b521121aac229e5b6a7006515dee855adaafff41ceab3
artifacts:
- article.txt
extraction_method: >-
  Verbatim transcription of artifacts/article.txt from the committed authenticated
  X Article bundle. X interface chrome is omitted: engagement counters, view counts,
  timestamps, and post-footer navigation. All retained lines appear byte-for-byte
  in artifact order.
---
dex
@dexhorthy
