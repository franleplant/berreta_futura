...
| Compute time per step ¹ | 10 ms | 30 seconds (default) / configurable to 5 minutes of [active CPU time](https://developers.cloudflare.com/workers/platform/limits/#cpu-time) |
| Duration (wall clock) per step ¹ | Unlimited | Unlimited - for example, waiting on network I/O calls or querying a database |
...
| Maximum length of a Workflow name ⁹ | 64 characters | 64 characters |
| Maximum length of a Workflow instance ID ⁹ | 100 characters | 100 characters |
