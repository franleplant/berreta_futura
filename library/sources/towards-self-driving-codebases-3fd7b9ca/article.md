...
![Self-coordination diagram showing agents connecting to a shared coordination file](media/001.png)
...
![Structured roles diagram showing Planner, Executor, Workers, and Judge in a pipeline](media/002.png)
...
![Continuous executor diagram showing an infinite executor loop with workers](media/003.png)
...
![Final system design showing recursive planners, sub-planners, workers, and git](media/004.png)
